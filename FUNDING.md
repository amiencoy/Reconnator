...
Funding and sponsorship will be directed toward:
...
4. **Documentation and community maintenance** — improving guides, examples,
   contributor onboarding, issue triage, and community support.
5. **Sustainable development** — building new features and integrations, refreshing
   AI model compatibility, and maintaining scanner scripts as upstream tools evolve.
