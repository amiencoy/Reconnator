...
5. Create and push an annotated tag:
   ...
   ```bash
   git tag -a v2.2.1 -m "Reconnator v2.2.1"
...
Stable version tags trigger container publishing. For `v2.2.1`, the expected
image aliases are:

```text
ghcr.io/amiencoy/reconnator:2.2.1
