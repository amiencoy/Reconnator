...
5. Create and push an annotated tag:
   ...
   ```bash
   git tag -a v2.2.0 -m "Reconnator v2.2.0"
...
Stable version tags trigger container publishing. For `v2.2.0`, the expected
image aliases are:

```text
ghcr.io/amiencoy/reconnator:2.2.0
