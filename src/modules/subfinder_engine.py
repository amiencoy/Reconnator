...
# Note: If Subfinder fails (e.g., crt.sh timeout), the MCP server will automatically fallback to   #
# AlienVault OTX fetcher to ensure we don't walk away empty-handed.                                #
# ================================================================================================ #
